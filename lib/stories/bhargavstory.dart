...
class Bhargavstory extends StatefulWidget {
  const Bhargavstory({super.key});

  @override
  State<Bhargavstory> createState() => _BhargavstoryState();
}

class _BhargavstoryState extends State<Bhargavstory> {
  @override
      ...
      body: SingleChildScrollView(scrollDirection: Axis.vertical,
        child: Column(
          children: [
            Stack(
              children: [
                Image.asset('assets/Homepage/post/bhargav4.jpg',height:732,width:500,fit: BoxFit.fitWidth,),
                    ...
                    child: ListTile(
                      leading: Container(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(50),
                          child: Image.asset(
                            'assets/Homepage/post/bhargav1.jpg',
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
